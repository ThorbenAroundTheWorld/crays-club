(function () {
  ...
  function formMarkup(location, defaultTargetGroup) {
    ...
    return [
      ...
      '<option value="Bitcoin-Native Users">Bitcoin-Native Users</option>',
      '<option value="Web3 &amp; Web5 Enthusiasts">Web3 &amp; Web5 Enthusiasts</option>',
      '<option value="Nostr Community Members">Nostr Community Members</option>',
      '<option value="Crypto Nomads">Crypto Nomads</option>',
      ...
      '<option value="Builders &amp; Makers">Builders &amp; Makers</option>',
      '<option value="Tech Startups">Tech Startups</option>',
      '<option value="Lifestyle Brands">Lifestyle Brands</option>',
      '<option value="Creators &amp; Influencers">Creators &amp; Influencers</option>',
      '<option value="Podcasters">Podcasters</option>',
      '<option value="Artists">Artists</option>',
      '<option value="Musicians">Musicians</option>',
      '<option value="Fashion Industry Professionals">Fashion Industry Professionals</option>',
      '<option value="Designers &amp; Architects">Designers &amp; Architects</option>',
      '<option value="Film &amp; Media Professionals">Film &amp; Media Professionals</option>',
      '<option value="International Business Travelers">International Business Travelers</option>',
      '<option value="Community Builders">Community Builders</option>',
      '<option value="DAO &amp; RWA Enthusiasts">DAO &amp; RWA Enthusiasts</option>',
      '<option value="AI, Blockchain &amp; Fintech Professionals">AI, Blockchain &amp; Fintech Professionals</option>',
      '<option value="Luxury Lifestyle Consumers">Luxury Lifestyle Consumers</option>',
      '<option value="Event &amp; Festival Communities">Event &amp; Festival Communities</option>',
      '<option value="Beach Club &amp; Resort Guests">Beach Club &amp; Resort Guests</option>',
      '<option value="Coworking &amp; Coliving Communities">Coworking &amp; Coliving Communities</option>',
      '<option value="Freedom-Oriented Global Citizens">Freedom-Oriented Global Citizens</option>',
      '<option value="Ownership &amp; Decentralization Advocates">Ownership &amp; Decentralization Advocates</option>',
      '<option value="Tech-Oriented Lifestyle Consumers">Tech-Oriented Lifestyle Consumers</option>',
      '<option value="Experience-Driven Professionals">Experience-Driven Professionals</option>',
      '<option value="High-Agency Networkers">High-Agency Networkers</option>',
      '<option value="Privacy &amp; Sovereignty Focused Users">Privacy &amp; Sovereignty Focused Users</option>',
      '<option value="Professionals Seeking Inspiring Work Environments">Professionals Seeking Inspiring Work Environments</option>',
      '<option value="People Interested in Work, Live &amp; Play Ecosystems">People Interested in Work, Live &amp; Play Ecosystems</option>',
      '</select></label>',
